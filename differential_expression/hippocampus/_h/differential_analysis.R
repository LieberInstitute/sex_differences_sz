...
prep_data <- function(feature){
    counts_lt = list("genes"=here("input/counts/_m/rse_gene.BrainSeq_Phase2_HIPPO.Gencode41.n447.Rdata"), 
                     "transcripts"=here("input/counts/_m/rse_tx.BrainSeq_Phase2_HIPPO.Gencode41.n447.Rdata"),
                     "exons"=here("input/counts/_m/rse_exon.BrainSeq_Phase2_HIPPO.Gencode41.n447.Rdata"),
                     "junctions"=here("input/counts/_m/rse_jxn.BrainSeq_Phase2_HIPPO.Gencode41.n447.Rdata"))
