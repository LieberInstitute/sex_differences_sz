...
get_sig_genes <- function(){
    ...
    return(data.table::fread(fn) |>
           dplyr::filter(Type == "Gene", Sex == "Male"))
}
...
plot_upset <- function(){
    ...
    top_annot = upset_top_annotation(
        ...
        annotation_name_rot = 90)
                                        # Plotting
    pdf('BrainSeq_sexBYsz_upsetR.pdf', width=8, height=4)
...
plot_upset_transposed <- function(){
    ...
    top_ha = HeatmapAnnotation(
        ...
        annotation_name_rot = 90)
                                        # Plotting
    pdf('BrainSeq_sexBYsz_upsetR_tranposed.pdf', width=5, height=10)
...
print(intersect(caudate$Feature, dlpfc$Feature))

print("Caudate vs Hippocampus")
print(intersect(caudate$Feature, hippo$Feature))

print("DLPFC vs Hippocampus")
print(intersect(dlpfc$Feature, hippo$Feature))
